...
| Prop          | Type                      | Default    | Description                 |
| ------------- | ------------------------- | ---------- | --------------------------- |
| `options`     | `SelectOption[]`          | _required_ | Array of `{ value, label }` |
...
| `onClose`  | `() => void` | _required_ | Called when modal should close |
...
| Prop        | Type                                          | Default    | Description     |
| ----------- | --------------------------------------------- | ---------- | --------------- |
| `variant`   | `'success' \| 'error' \| 'warning' \| 'info'` | _required_ | Toast style     |
| `message`   | `string`                                      | _required_ | Toast message   |
...
| Prop       | Type        | Default    | Description               |
| ---------- | ----------- | ---------- | ------------------------- |
| `label`    | `string`    | _required_ | Field label               |
| `error`    | `string`    | —          | Error message             |
...
| Prop           | Type                            | Default    | Description                            |
| -------------- | ------------------------------- | ---------- | -------------------------------------- |
| `items`        | `ListItem[]`                    | _required_ | Array of `{ id, label, description? }` |
...
| Prop      | Type                                          | Default    | Description        |
| --------- | --------------------------------------------- | ---------- | ------------------ |
| `columns` | `Column[]`                                    | _required_ | Column definitions |
| `data`    | `Record<string, unknown>[]`                   | _required_ | Row data           |
...
| Prop          | Type                          | Default    | Description              |
| ------------- | ----------------------------- | ---------- | ------------------------ |
| `items`       | `SidebarItem[]`               | _required_ | Navigation items         |
