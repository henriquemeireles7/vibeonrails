...
import { ErrorReporter, createErrorReporter, type ErrorReport } from './reporter.js';
...
describe('Error Reporter', () => {
  ...
  describe('query', () => {
    ...
    it('should combine filters', () => {
      ...
      reporter.capture(new CatalogError('VOR_AUTH_001'), { requestId: 'req-1' });
      reporter.capture(new CatalogError('VOR_AUTH_001'), { requestId: 'req-2' });
      reporter.capture(new CatalogError('VOR_DB_001'), { requestId: 'req-1' });

      const results = reporter.query({ code: 'VOR_AUTH_001', requestId: 'req-1' });
